            ...
            </div>
            {
                isEditing ? (
                    <div className="flex flex-col gap-y-2">
                        ...
                        <Button className="mt-4 w-max" onClick={onUpload} disabled={isLoading || !image}>
                            Unggah gambar
                        </Button>
                    </div>
                ): (
                   !school.school_image ? (
                       <div
                           className="flex items-center justify-center h-60 bg-slate-200 rounded-md overflow-hidden mt-2">
