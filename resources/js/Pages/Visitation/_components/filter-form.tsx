...
const FilterForm = ({ data }: FilterFormProps) => {
    ...
    return (
        <div className="md:w-1/2 w-full flex md:flex-row flex-col  items-center md:gap-x-4 gap-x-0 gap-y-2 md:gap-y-0">
            <Select
                name="selectedYear"
                onValueChange={(e) => handleChange(e, "selectedYear")}
            >
                ...
                <SelectContent>
                    {data.map((item, i) => (
                        <SelectItem key={i} value={item.academic_year}>
                            {item.academic_year}
                        </SelectItem>
                    ))}
                </SelectContent>
            ...
            <Select
                ...
                onValueChange={(e) => handleChange(e, "selectedSemester")}
            >
                <SelectTrigger className="md:w-[180px] w-full">
            ...
            <Button
                ...
                className="px-7 w-full md:w-max"
            >
